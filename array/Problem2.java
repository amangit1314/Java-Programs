...
//Title : Java program to find the maximum & minimum element in given array
class Problem2{
    ...
    static Pair getMinMax(int[] a, int n){
        ...
        //IF their are so many or more than 2 elements in array THEN following loop will work
        for (i = 0; i < n; i++){
